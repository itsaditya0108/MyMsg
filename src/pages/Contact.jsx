...
export default function Contact() {
  return (
    <div className="pt-48 pb-32 min-h-screen relative bg-brand-bg md:bg-white overflow-hidden">
            ...
            >
              <div className="flex items-start gap-6">
                ...
                <div>
                  ...
                  <p className="text-xl font-black text-slate-900">Tech Hub, London UK</p>
                </div>
              </div>
            </motion.div>
          </div>
          ...
          <div className="lg:col-span-7">
             ...
             >
                ...
                <div className="space-y-3">
                    ...
                    <textarea rows="5" className="w-full bg-white border border-slate-200 rounded-2xl px-6 py-4 text-slate-900 focus:outline-none focus:border-brand-indigo transition-all font-bold resize-none placeholder:text-slate-300" placeholder="How can we help you?"></textarea>
                </div>
