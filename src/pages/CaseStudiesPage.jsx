      ...
      <div className="container mx-auto px-6 lg:px-12 xl:px-24">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-slate-500 max-w-2xl mx-auto leading-relaxed font-medium">
             Explore how industry leaders are leveraging <span className="text-brand-indigo font-black">My Msg RCS</span> to redefine business messaging and drive measurable growth.
          </p>
        </motion.div>
