      ...
      <div className="container mx-auto px-6 lg:px-12 xl:px-24 relative z-10">
        <div className="flex flex-col lg:flex-row lg:items-end justify-between mb-24 gap-12">
          <div className="max-w-2xl">
            ...
            >
              Unlock the future of customer interaction with the most advanced <span className="text-brand-indigo font-bold">MyMsg RCS</span> toolset designed for enterprise scale.
            </motion.p>
          </div>
